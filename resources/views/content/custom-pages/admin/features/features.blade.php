...
@section('title', trans('features/features.features_list'))
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <table class="user-list-table table">
                    ...
                    <tr>
                        <th></th>
                        <th>{{trans('features/features.title')}}</th>
                        <th>{{trans('features/features.desc')}}</th>
                        <th>{{trans('features/features.Actions')}}</th>
                    </tr>
                    </thead>
                </table>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel22">{{trans('features/features.desc_for')}}<span id="trip"></span></h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
...
@section('page-script')
    {{-- Page js files --}}
    <script src="{{ asset('js/scripts/custom-pages/features/features-list.js') }}"></script>
